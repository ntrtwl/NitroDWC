                ...
                ArrayElementFreeFn elemFreeFn)
{
	...
	assertWithLine(array, 82);
	assertWithLine(elemSize, 83);
...
void *ArrayNth(DArray array, int n)
{
	...
	assertWithLine( (n >= 0) && (n < array->count), 148);
...
{
	GS_ASSERT (array)
	assertWithLine( (n >= 0) && (n <= array->count), 167);
...
{
 	GS_ASSERT (array)
  	assertWithLine( (n >= 0) && (n < array->count), 192);
...
{
 	GS_ASSERT (array)
   	assertWithLine( (n >= 0) && (n < array->count), 202);
...
{
 	GS_ASSERT (array)
	assertWithLine( (n >= 0) && (n < array->count), 211);
