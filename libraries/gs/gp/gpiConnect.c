...
)
{
	...
	// Connect the socket.
	//////////////////////
	assertWithLine(address.sin_addr.s_addr != 0, 144);
...
)
{
	...
	gpiAppendIntToBuffer(connection, &iconnection->outputBuffer, (short)htons(iconnection->peerPort));
...
)
{
	...
	////////////////////////////////////////
	assertWithLine(state == GPI_CONNECTED, 751);
...
)
{
    ...
    //////////////////////////////////////////////////////////////////
	if(profile->buddyStatus && iconnection->infoCachingBuddyOnly==GPIFalse)
	{
	...
	if ((!profile->cache) ||
		(iconnection->infoCachingBuddyOnly==GPITrue && !profile->buddyStatus))
	{
