...
{
	assertWithLine(dest != NULL, 47);
	assertWithLine(src != NULL, 48);
...
)
{
	...
	// Check for NULL.
	//////////////////
	assertWithLine(command != NULL, 269);
    assertWithLine(key != NULL, 270);
    assertWithLine(value != NULL, 271);
    assertWithLine(len > 0, 272);
...
)
{
	...
	assertWithLine(buffer != NULL, 409);
	assertWithLine(key != NULL, 410);
	assertWithLine(value != NULL, 411);
