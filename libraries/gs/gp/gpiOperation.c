...
)
{
	...
	assertWithLine(connection != NULL, 34);
	assertWithLine(*connection != NULL, 35);
	assertWithLine(operation != NULL, 36);
...
)
{
	...
	if(operation->type == GPI_PROFILE_SEARCH)
	{
		...
		assertWithLine(iconnection->numSearches >= 0, 182);
